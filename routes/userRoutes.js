...
let {registerUserValidation,userLoginValidation,resetPasswordValidation,} = require("../validations/user/userDatavalidate");
...
router.post("/resetpassword/:id/:token",resetPasswordValidation,user.resetUserPassword);
